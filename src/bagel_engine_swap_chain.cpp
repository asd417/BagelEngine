...
namespace bagel {
    ...
    BGLSwapChain::BGLSwapChain(BGLDevice& deviceRef, VkExtent2D extent, std::shared_ptr<BGLSwapChain> previous)
    ...
    void BGLSwapChain::createSwapChain() {
    ...
    void BGLSwapChain::createImageViews() {
    ...
    VkRenderPass BGLSwapChain::createDeferredRenderPass() {
        ...
        std::array<VkAttachmentReference, 3> attachmentsRef = { positionAttachmentRef, normalAttachmentRef, albedoAttachmentRef };
    ...
    void BGLSwapChain::createRenderPass() {
        VkAttachmentDescription depthAttachment{};
        depthAttachment.format = findDepthFormat();
        depthAttachment.samples = VK_SAMPLE_COUNT_1_BIT;
        // LOAD so the G-buffer depth blitted before this pass is preserved for transparent objects
    ...
    void BGLSwapChain::createFramebuffers() {
    ...
    void BGLSwapChain::createDepthResources() {
    ...
    void BGLSwapChain::createSyncObjects() {
    ...
    VkSurfaceFormatKHR BGLSwapChain::chooseSwapSurfaceFormat(
    ...
    VkExtent2D BGLSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
    ...
    VkFormat BGLSwapChain::findDepthFormat() {
